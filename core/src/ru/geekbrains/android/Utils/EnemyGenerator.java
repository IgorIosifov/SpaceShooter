...
public class EnemyGenerator {
    ...
    private static final float ENEMY_BIG_BULLET_VY = -0.03f;
    ...
    public EnemyGenerator(Rect worldBounds, EnemyPool enemyPool
            , TextureAtlas atlas) {
    ...
    public void generate(float delta) {
        ...
        if (generateTimer >= generateInterval) {
            ...
            enemy.pos.x = RandomFloat.nextFloat(worldBounds.getLeft() +
                    enemy.getHalfWidth(), worldBounds.getRight() -
                    enemy.getHalfWidth());
